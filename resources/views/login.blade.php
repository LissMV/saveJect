<x-layout>
    ...
    <div class="flex justify-center items-center h-screen">
        <div id="glassEffect" class="w-full max-w-md rounded-lg p-8">
            ...
            <form action="/login" method="POST" class="text-center">
                ...
                <div>
                    <button
                        class="w-full bg-emerald-500 text-white font-semibold py-2 px-4 rounded-full hover:bg-emerald-600 focus:outline-none focus:bg-emerald-600"
